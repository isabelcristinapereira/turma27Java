		  ...
		  inteiro cont = 0
			...
			escreva("SLOGAN\n")
              	faca {
              		...
              		escreva ("digite 1 para credito e  2 para débito")
              		leia (acao)
		      	...
		      	saldo=debito(saldo, valor) 
              		...
              		leia(opc)
              		se(opc==1){
              			escreva("Você deseja um talão ?\n1 -sim 2- não\n")
              			leia(mov)
              			se(mov==1){
              			escreva("Você pode escolher até 3 taloens, digite a quantidade desejada.")
              			leia(talao)
              			se(talao>3){
              				escreva("A quantidade de taloens ultrapassou o limite permitido")
              			}
              			senao{
              		...
              		senao {
              			escreva ("Obrigada por ter chegado até aqui.")
 ...
 * 
 * @POSICAO-CURSOR = 6557; 
 * @DOBRAMENTO-CODIGO = [50, 91, 144, 155];
 * @PONTOS-DE-PARADA = ;
